...
<h1>
           Input Data Siswa SMK 12 Banjarnegara               </h1>
...
<textarea class="form-control" id="eket" name="kelas" placeholder=""></textarea><br/>
...
data_app += '<td>'+ daftar_data[i].id_data + 
'</td>'+
                                          
'<td>'+ daftar_data[i].nama + 
'</td>'+
                                          
'<td>'+ daftar_data[i].alamat + 
'</td>'+
                                          
'<td>'+ daftar_data[i].ket + 
' </td>'+
...
id_data = parseInt(localStorage.getItem('id_data'));  }
 ...
 id_data ++; daftar_data.push({'id_data':id_data, 'nama':nama, 'alamat':alamat, 'ket':ket});
